module.exports = {
  siteTitle: 'Macramé',
  siteTitleAlt: 'Macramé', // This allows an alternative site title for SEO schema.
  publisher: 'Brandon Pampuch', // Organization name used for SEO schema
  siteDescription:
  ...
  shortTitle: 'Macramé', // Used for App manifest e.g. Mobile Home Screen
  ...
  copyright: 'Copyright © 2019 Macramé', // Copyright string for the RSS feed
}
